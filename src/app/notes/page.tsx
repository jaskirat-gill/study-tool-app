          ...
          <div className="text-center py-12">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-muted-foreground mb-6">
                Create your first set of AI-generated study notes from clipboard content.
              </p>
              <Button asChild>
                <Link href="/notes/generate">
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="text-2xl font-bold">
                {notes.filter(note => {
                  const daysDiff = Math.floor((Date.now() - note.created.getTime()) / (1000 * 60 * 60 * 24));
                  return daysDiff <= 7;
                }).length}
              </div>
        ...
        {searchQuery && filteredNotes.length === 0 && (
          <div className="text-center py-8">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-muted-foreground">
                No notes match your search query &quot;{searchQuery}&quot;. Try a different search term.
              </p>
            </div>
          </div>
        )}
